    ...
    <footer className="py-16 px-6" style={{ background: 'rgba(0, 103, 163, 1)' }}>
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex justify-center space-x-4 mb-8">
          ...
          <a
            href="https://www.instagram.com/thethirdhighexperience/"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 bg-yellow-400 hover:bg-yellow-500 rounded-full flex items-center justify-center transition-colors"
          >
          ...
          <a
            href="https://youtube.com/@thegreatspiritualawakening2027?si=4rQ5wEnlkJrg3uKm"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 bg-yellow-400 hover:bg-yellow-500 rounded-full flex items-center justify-center transition-colors"
          >
          ...
          {/* Gmail */}
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=thethirdhighexperience@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 bg-yellow-400 hover:bg-yellow-500 rounded-full flex items-center justify-center transition-colors"
          >
        ...
        <p className="text-white/60 text-sm">
          © 2026 TheThirdHigh Experience. All rights reserved.
        </p>
      </div>
    </footer>
  );
